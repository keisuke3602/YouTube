...
def create_video(selected_file, selected_rows):
        ...
        creds = ServiceAccountCredentials.from_json_keyfile_name('/Users/keisukewatanabe/Desktop/moviepy/speedy-anthem-340212-ceb97fd9f3a8.json', scope)
        ...
        bgm = AudioFileClip('/Users/keisukewatanabe/Desktop/moviepy/music/Kevin_MacLeod_-_Canon_in_D_Major.mp3')
        clips = []
        audio_clips = []
        start_time = 0
